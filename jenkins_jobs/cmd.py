...
def execute(options, config):
    ...
    # user provided list of plugins that will be used to test version
    # specific behavior differences in jenkins plugins
    plugins_info = [{'shortName': '', 'version': '', 'longName': ''}]
