...
def execute(options, config):
    ...
    if user is None and password is None:
        ...
        logger.warn("User provided without password, authenticated requests "
                    "to Jenkins may fail!")
    elif user is None and password is not None:
        logger.warn("Password provided without a user to use, authenticated "
                    "requests to Jenkins may fail!")
