...
class ModuleRegistry(object):
    ...
    def _get_plugins_versions(plugins_list):
        def add_plugin_version(plugin_version, plugin_info):
        ...
        for plugin_info in plugins_list:
            add_plugin_version(plugin_version, plugin_info)
    ...
    def get_plugin_version(self, plugin_name, alt_plugin_name=None, default=None):
        """Provide plugin version within a module's impl of Base.gen_xml.

        The return value is plugin version obtained directly from a running
        Jenkins instance.
        ...
        :arg str alt_plugin_name: Alternative plugin name. Use it if plugin_name
