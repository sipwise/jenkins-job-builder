...
class JJBConfig(object):
    ...
    def _setup(self):
        ...
        if not config.getboolean("jenkins", "query_plugins_list"):
        ...
        self.builder['plugins_info'] = self.plugins_list
    ...
    def validate(self):
        ...
        if (self.builder['plugins_info'] is not None and
            ...
            raise JenkinsJobsException("plugins_list must contain a list!")
