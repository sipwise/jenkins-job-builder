...
class Worker(threading.Thread):
    ...
    runs it's function with the passed parameters and returns the result
...
def parallelize(func):
    ...
    def parallelized(*args, **kwargs):
        ...
        parallel (depends on the number of detected cores) and return an array
        with the results of the executions in the same order the parameters
        were passed.
        """
