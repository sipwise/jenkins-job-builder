...
class YamlParser(object):
    ...
    def parse(self, fn):
        ...
        See :py:meth:`jenkins_jobs.builder.Builder.load_files` load_files method to see how
        this method is called. 

        See the test_yamlparser.py cases for examples loading strings and files.
        """
        try:
            yaml_source = open(fn)
        except IOError:
