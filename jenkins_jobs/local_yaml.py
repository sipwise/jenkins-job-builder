...
Example:
    ...
    .. include:: /../../tests/localyaml/fixtures/include001.yaml
...
Example:
    ...
    .. include:: /../../tests/localyaml/fixtures/include-raw001.yaml
...
Example:
    ...
    .. include:: /../../tests/localyaml/fixtures/include-raw-escaped001.yaml
...
Example:
    ...
    .. include:: /../../tests/yamlparser/fixtures/lazy-load-jobs001.yaml
