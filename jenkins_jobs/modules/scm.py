...
def svn(self, xml_parent, data):
    ...
    :arg str workspaceupdater: optional argument to specify how to update the workspace
    ...
    module = XML.SubElement(locations, 'hudson.scm.SubversionSCM_-ModuleLocation')
    ...
    XML.SubElement(scm, 'workspaceUpdater', {'class': 'hudson.scm.subversion.'+updaterclass})
