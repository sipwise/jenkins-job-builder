...
remoteName/\*')
    ...
    if 'submodule' in data:
        ...
        ext = XML.SubElement(exts_node, ext_name)
        submodule_disable = str(data['submodule'].get('disable', False)) \
            .lower()
        submodule_recursive = str(data['submodule'].get('recursive', False)) \
            .lower()
        submodule_tracking = str(data['submodule'].get('tracking', False)) \
            .lower()
