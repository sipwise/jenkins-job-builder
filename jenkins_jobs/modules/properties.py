...
def slack(parser, xml_parent, data):
    ...
    :arg bool start-notify: post messages about build start \
              event (default: False)
    :arg bool notify-success: post messages about successful \
              build event (default: False)
    :arg bool notify-aborted: post messages about aborted \
              build event (default: False)
    :arg bool notify-not-built: post messages about build \
              set to NOT_BUILT status (default: False)
    :arg bool notify-unstable: post messages about unstable \
              build event (default: False)
    :arg bool notify-failure:  post messages about build \
              failure event (default: False)
    :arg bool notify-back-to-normal: post messages about \
              build being back to normal after being unstable or failed \
              (default: False)

    Example:

    .. literalinclude:: /../../tests/properties/fixtures/slack.yaml
