...
def groovy_label(parser, xml_parent, data):
    """yaml: groovy-label
    ...
    :arg list url: A path or URL to a JAR file (default '')
    ...
    convert_mapping_to_xml(groovy_security, data, mapping, fail_required=True)
