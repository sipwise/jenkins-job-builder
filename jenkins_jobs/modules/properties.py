...
def builds_chain_fingerprinter(parser, xml_parent, data):
    ...
    :arg bool per-builds-chain: enable builds hierarchy fingerprinting (default False)
    :arg bool per-job-chain: enable jobs hierarchy fingerprinting (default False)
    ...
    fingerprinter = XML.SubElement(xml_parent,
                                   'org.jenkinsci.plugins.buildschainfingerprinter.'
