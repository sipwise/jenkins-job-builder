...
def promoted_build(parser, xml_parent, data):
    ...
    .. seealso::
        :func:`batch_tasks` which serve similar purpose, but batch-tasks are
...
def batch_tasks(parser, xml_parent, data):
    ...
    :arg list batch_tasks: Batch tasks.

        :Task: * **name** (`str`) Task name.
               * **script** (`str`) Task script.

    Example::
    .. literalinclude:: ../../tests/publishers/fixtures/batch-task.yaml
    """
