...
def extended_choice(parser, xml_parent, data):
    ...
    logger.warn('Use of the extended-choice property is deprecated and '
                'can cause problems if any parameters are defined in the '
                'parameter section.  You should use the extended-choice '
                'option in the parameter section instead.')
