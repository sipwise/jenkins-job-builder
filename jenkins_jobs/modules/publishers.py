...
def cloverphp(parser, xml_parent, data):
    ...
    Your job builder should pass to PHPUnit the --coverage-clover option
    pointing to a file in the workspace (ex: clover-coverage.xml). The filename
    has to be filled in the `xmllocation` field.

    :arg str xmllocation: Path to the coverage XML file generated by PHPUnit
    ...
    XML.SubElement(cloverphp, 'xmlLocation').text = data.get('xmllocation')
