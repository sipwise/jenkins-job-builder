...
def hockeyapp(parser, xml_parent, data):
    ...
    :arg str symbols: An optional path, relative to the build's workspace,
        to the generated dSYM.zip (iOS and MacOS) or mapping.txt (Android) file.
    :arg str packed-libraries: Optional path, relative to the build's workspace,
        to an archive with generated .so files. This archive must have the
        following structure: ${ARCHITECTURE}/*.so
    ...
    :arg str restrict-downloads-to-tags: By entering a comma-separated list of tags here,
        you can restrict downloads of your app to only users/devices with these tags. (default "")
    :arg bool notify-team: Enable if you want HockeyApp to notify your team about each
        uploaded version. (false)
