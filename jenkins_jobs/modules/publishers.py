...
def jms_messaging_notify(registry, xml_parent, data):
    """yaml: jms-messaging-notify
    ...
    .. literalinclude::
        ../../tests/triggers/fixtures/jms-messaging-notify-full.yaml
       :language: yaml

    Minimal Example:

    .. literalinclude::
        ../../tests/triggers/fixtures/jms-messaging-notify-minimal.yaml
       :language: yaml
    """
    ...
    helpers.convert_mapping_to_xml(namespace, data, mapping, fail_required=True)
