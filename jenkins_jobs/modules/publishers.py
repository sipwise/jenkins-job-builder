...
from jenkins_jobs.modules.helpers import test_fairy
...
def test_fairy_androidios(parser, xml_parent, data):
    """yaml: test-fairy
    This plugin helps you to upload Android APKs or iOS IPA files to
    www.testfairy.com this function handles the Android configuration.

    Requires the Jenkins :jenkins-wiki:`Test Fairy Plugin
    <TestFairy+Plugin>`.

    :arg str platform: Select platform to upload to
    :platform:
        * **android**
        * **ios**
    ...
    :arg str proguard-file: Path to Proguard file. Path of mapping.txt from
        your proguard output directory, only applies to **android** platform.
        (optional)
    :arg str dSYM-file: Path to .dSYM.zip file, only applies to **ios** platform. (optional)
    ...
    :arg str keystorepath: Path to Keystore file, only applies to **android** platform.
    :arg str storepass: Password for the keystore, only applies to **android** platform. (default android)
    :arg str alias: alias for key, only applies to **android** platform. (default androiddebugkey)
    :arg str keypass: password for the key, only applies to **android** platform. (optional)
