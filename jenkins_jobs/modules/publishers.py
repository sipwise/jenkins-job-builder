...
def mqtt(registry, xml_parent, data):
    ...
    (optional)
    :arg str topic: the message topic (optional, default is
    "jenkins/$PROJECT_URL")
    :arg str message: the message itself (optional, default is "$BUILD_RESULT")
    :arg str qos: one of AT_MOST_ONCE, AT_LEAST_ONCE, or EXACTLY_ONCE
    (optional, default is AT_MOST_ONCE)
    :arg bool retain-message: whether to resend message or not when a new
    client connects (optional, default is false)
