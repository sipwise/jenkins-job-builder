...
def ircbot(parser, xml_parent, data):
    ...
    :arg string strategy: When to send notifications
        ...
        :strategy values:
            * **all** always (default)
            * **any_failure** on any failure_and_fixed
            * **failure_and_fixed** on failure and fixes
            * **new_failure_and_fixed** on new failure and fixes
            * **statechange_only** only on state change
        ...
        - ircbot:
            ...
            channels:
                ...
                - name: '#jenkins-channel2'
                  notify-only: true
            matrix-notifier: only_configurations
    ...
    matrix_dict = {'all': 'ALL',
                   'only_configurations': 'ONLY_CONFIGURATIONS',
