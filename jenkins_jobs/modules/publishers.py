...
def tap(parser, xml_parent, data):
    ...
    :arg bool include-comment-diagnostics: Include comment diagnostics (#) in
        the results table (default false)
    :arg bool validate-tests: Validate number of tests (default false)
    :arg bool plan-required: TAP plan required? (default true)
    :arg bool verbose: Print a message for each TAP stream file (default true)
    :arg bool show-only-failures: show only test failures (default false)
