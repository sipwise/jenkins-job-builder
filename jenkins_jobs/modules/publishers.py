...
def clone_workspace(parser, xml_parent, data):
    ...
    criteria_list = ['Not Failed', 'Successful', 'Any']

    if 'criteria' in data and data['criteria'] not in criteria_list:
    ...
    if 'archive-method' in data and data['archive-method'] not in archive_list:
        raise JenkinsJobsException(
