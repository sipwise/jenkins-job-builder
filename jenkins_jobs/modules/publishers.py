...
def cloudformation(parser, xml_parent, data):
    ...
    :arg list create-stacks: List of stacks to create with the following
      attributes
      ...
      * **arg str parameters** A comma separated list of key/value pairs
      ...
      * **arg int sleep** Number of seconds to wait before continuing to the
        next step (default 0)
      * **arg array region** The region to run cloudformation in.  Valid
        values are:
        ...
        * **ap-northeast-1**
        * **sa-east-1**
    :arg list delete-stacks: List of stacks to delete with the following
      attributes
