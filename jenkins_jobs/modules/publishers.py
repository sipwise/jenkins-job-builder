...
def conditional_publisher(parser, xml_parent, data):
    ...
    for cond_action in data:
        ...
        evaluation_flag = cond_action.get('on-evaluation-failure')
        if evaluation_flag in evaluation_classes.keys():
            evaluation_class = \
                evaluation_classes[evaluation_flag]
        elif evaluation_flag is None:
            evaluation_class = evaluation_classes['fail']
        else:
