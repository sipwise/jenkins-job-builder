...
def trigger_parameterized_builds(parser, xml_parent, data):
    ...
    :arg list boolean-parameters: Pass boolean parameters to the downstream
        jobs. (optional)

        :Boolean Parameters:
            * **name** (`str`) - Name of the boolean parameter. (default '')
            * **value** (`bool`) - Value of the parameter. (default false)
        ...
        if ('predefined-parameters' in project_def
            ...
            if ('boolean-parameters' in project_def
                ...
                for param in params_list:
                    ...
                    XML.SubElement(param_tag, 'name').text = param.get(
                        'name', '')
                    XML.SubElement(param_tag, 'value').text = str(
                        param.get('value', False)).lower()
        else:
