...
def base_email_create(parset, xml_parent, data, ttype):
    ...
    for email_option in data:
        if 'recipientlist' in email_option:
            email_config['recipientlist'] = email_option.get('recipientlist')
            ...
            email_config['attach-build-log'] = str(email_option.get('attach-build-log')).lower()
        elif 'compress-log' in email_option:
            email_config['compress-log'] = str(email_option.get('compress-log')).lower()
    ...
    XML.SubElement(email, 'recipientList').text = email_config['recipientlist']
    XML.SubElement(email, 'subject').text = email_config['subject']
    XML.SubElement(email, 'body').text = email_config['body']
    XML.SubElement(email, 'attachmentsPattern').text = email_config['attachments']
    XML.SubElement(email, 'attachBuildLog').text = email_config['attach-build-log']
    XML.SubElement(email, 'compressBuildLog').text = email_config['compress-log']
