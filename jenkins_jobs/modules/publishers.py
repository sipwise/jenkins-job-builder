...
def email_ext(parser, xml_parent, data):
    ...
    if data.get('success', False):
        base_email_create(
             parser, ctrigger, data.get('success'), 'SuccessTrigger')
    if data.get('fixed', False):
        base_email_create(
             parser, ctrigger, data.get('fixed'), 'FixedTrigger')
