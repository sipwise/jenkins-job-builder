...
def whitesource(parser, xml_parent, data):
    ...
    :arg str project-token: Token uniquely identifying the project to update
        (Default '')
    :arg list includes: list of libraries to include, will be joined together
        into a space separated string (Optional)
    :arg list excludes: list of libraries to exclude, will be joined together
        into a space separated string (Optional)
