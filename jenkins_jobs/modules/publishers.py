...
def test_fairy_android(parser, xml_parent, data):
    ...
    :arg str proguard-file: Path to Proguard file. Path of mapping.txt from your
    ...
    mappings = [
        ...
        ('keypass', 'keypass', '')]
    convert_mapping_to_xml_fail_required(data, root, mappings)


def test_fairy_ios(parser, xml_parent, data):
    """yaml: test-fairy-ios
    This plugin helps you to upload  APKs or iOS IPA files to
    www.testfairy.com this function handles the IOS configuration.
    ...
    :arg str appfile: Path to App file (.apk). For example:
        $WORKSPACE/[YOUR_FILE_NAME].apk or full path to the apk file
    :arg str dSYM-file: Path to .dSYM.zip file. (optional)
    :arg str tester-groups: Tester groups to notify (optional)
    :arg bool notify-testers: Send email with changelogs to testers (default
        False)
    :arg bool autoupdate: Automatic update (default False)
