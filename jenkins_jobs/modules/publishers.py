...
def trigger_parameterized_builds(parser, xml_parent, data):
    ...
    :arg str only-exact-matrix-child-runs: Use only child builds triggered
        ...
        if ('predefined-parameters' in project_def
            ...
            if 'property-file' in project_def and project_def['property-file']:
                ...
                if 'use-matrix-child-files' in project_def:
                    # TODO: These parameter only affect execution in publishers
                    # of matrix projects; we should warn if it is used in other
                    # contexts.
