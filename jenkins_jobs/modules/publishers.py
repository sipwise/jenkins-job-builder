...
def sounds(parser, xml_parent, data):
    ...
    :arg dict unstable: Play on unstable. Specifying sound and conditions see above.
    :arg dict failure: Play on failure. Specifying sound and conditions see above.
    :arg dict not_built: Play on not built. Specifying sound and conditions see above.
    :arg dict aborted: Play on aborted. Specifying sound and conditions see above.
