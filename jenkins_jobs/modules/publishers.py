...
def git(parser, xml_parent, data):
    ...
    :arg list tags: tags to push at the completion of the build
        ...
        :tag: * **remote-name** (`str`) remote repo name to push to
                (Default: 'origin')
    ...
    tag_mappings = [('remote-name', 'targetRepoName', 'origin'),
                    ('name', 'tagName', None),
                    ('message', 'tagMessage', ''),
                    ('create-tag', 'createTag', False),
                    ('update-tag', 'updateTag', False)]

    branch_mappings = [('remote-name', 'targetRepoName', 'origin'),
                       ('name', 'branchName', None)]

    note_mappings = [('remote-name', 'targetRepoName', 'origin'),
