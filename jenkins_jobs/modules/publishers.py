...
def coverage(parser, xml_parent, data):
    ...
    :arg bool fail-unhealthy: Unhealthy projects will be failed
                              (default false)
    :arg bool fail-stable: Unstable projects will be failed (default false)
    ...
    :arg dict targets: Coverage targets. Each entry is the target name. Normal
                       target names are: Packages, Files, Classes, Methods,
                       Lines, Conditionals
         :targets:
                :arg int healthy: Set healthy reporting threshold (default 0)
                :arg int unhealthy: Set unhealthy reporting threshold
                                    (default 0)
                :arg int failing: Set failing reporting threshold (default 0)
