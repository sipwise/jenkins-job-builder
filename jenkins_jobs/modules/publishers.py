...
def sloccount(parser, xml_parent, data):
    ...
    :arg str pattern: Setting that specifies the generated raw
                      SLOCCount report files, such as **/sloccount.sc.
                      If no value is set, then the default **/sloccount.sc is
                      used. Be sure not to include any non-report files into
                      this pattern. The report files must have been generated
                      by sloccount using the "--wide --details" options.
    :arg str charset: The character encoding to be used to read the SLOCCount
                      result files. If no value is set, then the default UTF-8
                      is used.
    ...
    XML.SubElement(top, 'pattern').text = data.get('pattern',
                                                   '**/sloccount.sc')
