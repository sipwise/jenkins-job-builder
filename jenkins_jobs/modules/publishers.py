...
def checkstyle(parser, xml_parent, data):
    ...
    :arg dict thresholds: Configure failure levels. Can contain 'unstable'
     and 'failed' keys, each of them define several thresholds selected
     from: 'totalAll', 'totalHigh', 'totalNormal' and 'totalLow'.
