...
def jacoco(parser, xml_parent, data):
    ...
    mappings = [
        ('exec-pattern', 'execPattern', None),
        ('class-pattern', 'classPattern', None),
        ('source-pattern', 'sourcePattern', None),
