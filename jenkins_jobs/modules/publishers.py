...
def plot(parser, xml_parent, data):
    ...
    :arg str num-builds: number of builds to plot across
    ...
    :arg str style:  Specifies the graph style of the plot
                     ...
                     (default: 'line')
    :arg str use-descr: When false, the X-axis labels are formed
    ...
    :arg list series: list data series definitions
        ...
        :arg str url: for 'csv' and 'xml' file types
                      ...
                      (default: empty)
        :arg str display-table: for 'csv' file type
        ...
        :arg str xpath-type: The result type of the expression must be
                             supplied due to limitations in the
                             java.xml.xpath parsing.
                             The result can be: NODE, NODESET, BOOLEAN,
                             STRING, or NUMBER.
                             Strings and numbers will be converted to
    ...
    XML.SubElement(plugin, 'useDescr').text = \
        str(data.get('use-descr', False)).lower()
