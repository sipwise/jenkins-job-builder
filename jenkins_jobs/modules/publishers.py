...
def conditional_publisher(parser, xml_parent, data):
    ...
    boolean-expression Run the action if the expression expends to a
    ...
    shell              Run the action if the shell command succeed
    ...
    for cond_action in data:
        ...
        evaluation_class = \
            evaluation_classes[cond_action.get('on-evaluation-failure',
                                               'fail')]
