...
def sloccount(parser, xml_parent, data):
    ...
    :arg str report-files: Setting that specifies the generated raw
                           ...
                           If no value is set, then the default
                           **/sloccount.sc is used. Be sure not to include
                           any non-report files into this pattern.
                           The report files must have been generated
