...
def postbuildscript(parser, xml_parent, data):
    ...
    :arg bool onsuccess: Scripts are ran only if the build succeed
                         (default False)
    :arg bool onfailure: Scripts are ran only if the build fail (default True)
    :arg str execute-on: For matrix projects, scripts can be ran after each
