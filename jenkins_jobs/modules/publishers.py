...
def slack(parser, xml_parent, data):
    ...
    if 'team-domain' not in data:
            raise JenkinsJobsException('Missing \'team-domain\' option in Slack publisher')
    XML.SubElement(slack, 'teamDomain').text = data['team-domain']

    if 'auth-token' not in data:
            raise JenkinsJobsException('Missing \'auth-token\' option in Slack publisher')
    ...
    if 'room' not in data:
            raise JenkinsJobsException('Missing \'room\' option in Slack publisher')
