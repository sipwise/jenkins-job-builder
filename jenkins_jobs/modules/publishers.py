...
def cucumber_reports(registry, xml_parent, data):
    ...
    :arg bool parallel-testing: Run same test in parallel for multiple devices
        (default false)
    :arg str failed-steps-number: Maximum number of failed steps above which
        build result is changed (default false)
    :arg str skipped-steps-number: Maximum number of skipped steps above which
        build result is changed (default false)
    :arg str pending-steps-number: Maximum number of pending steps above which
        build result is changed (default false)
    :arg str undefined-steps-number: Maximum number of undefined steps above
        which build result is changed (default false)
    :arg str failed-scenarios-number: Maximum number of failed scenarios above
        which build result is changed (default false)
    :arg str failed-features-number: Maximum number of failed features above
        which build result is changed (default false)
    :arg list build-status: Build result to which the build should be set
        when the report becomes failed or unstable (default false)
    :arg trends-limit: Number of past reports that should be presented.
        Zero means unlimited number of builds (default false)
