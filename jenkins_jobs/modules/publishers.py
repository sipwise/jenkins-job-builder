...
def coverage(parser, xml_parent, data):
    ...
    :arg dict targets: Coverage targets. Each entry is the target name.
                       Normal target names are: Packages, Files, Classes,
                       Methods, Lines, Conditionals
         :targets:
                * **healthy** (`int`): Set healthy reporting threshold
                                       (default 0)
                * **unhealthy** (`int`): Set unhealthy reporting threshold
                                         (default 0)
                * **failing** (`int`): Set failing reporting threshold
                                       (default 0)
