...
def trigger_manual(parser, xml_parent, data):
    ...
    tbuilder = XML.SubElement(xml_parent,
                              ...
                              'buildpipeline.trigger.BuildPipelineTrigger', {'plugin': 'build-pipeline-plugin'})

    configs = XML.SubElement(tbuilder, 'configs')

    XML.SubElement(tbuilder, 'downstreamProjectNames').text = ", ".join(map(str,data['project']))
    ...
    projects = XML.SubElement(configs, 'projects')
