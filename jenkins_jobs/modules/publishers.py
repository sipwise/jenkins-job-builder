...
def postbuildscript(parser, xml_parent, data):
    ...
    :arg bool onsuccess: Deprecated, replaced with script-only-if-success
    :arg bool script-only-if-success: Scripts and builders are run only if the
                         build succeed (default True)
    :arg bool onfailure: Deprecated, replaced with script-only-if-failure
    :arg bool script-only-if-failure: Scripts and builders are run only if the
                         build fail (default False)
...
postbuildscript003.yaml
    ...
    if 'onsuccess' in data:
        ...
        success_xml.text = str(data.get('script-only-if-success',
                                        True)).lower()
    ...
    if 'onfailure' in data:
        ...
        failure_xml.text = str(data.get('script-only-if-failure',
                                        False)).lower()
