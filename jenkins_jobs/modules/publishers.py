...
def email(parser, xml_parent, data):
    ...
    :arg str recipients: Space separated list of recipient email addresses (optional)
...
def email_ext(parser, xml_parent, data):
    ...
    :arg str reply-to: Comma separated list of email addresses that should be in
