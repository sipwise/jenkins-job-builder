...
def test_fairy_androidios(parser, xml_parent, data):
    ...
    :arg str proguard-file: Path to Proguard file. Path of mapping.txt from
        ...
        (optional)
    :arg str dSYM-file: Path to .dSYM.zip file, only applies to **ios**
        platform. (optional)
    ...
    :arg str keystorepath: Path to Keystore file, only applies to
        **android** platform.
    :arg str storepass: Password for the keystore, only applies to **android**
        platform. (default android)
    :arg str alias: alias for key, only applies to **android** platform.
        (default androiddebugkey)
    :arg str keypass: password for the key, only applies to **android**
        platform. (optional)
