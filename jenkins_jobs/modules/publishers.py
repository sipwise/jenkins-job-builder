...
def rundeck(parser, xml_parent, data):
    ...
    :arg str job-id: The RunDeck job identifier, this could be:
        * ID example : "42"
    ...
    :arg str tag: Used for on-demand job scheduling on rundeck: if a tag is
      ...
      SCM changelog.
    :arg str wait-for-rundeck: If true Jenkins will wait for the job to
      complete, if false the job will be started and Jenkins will move on.
    :arg str fail-the-build: If true a RunDeck job failure will cause the
      Jenkins build to fail.
