...
from jenkins_jobs.modules.helpers import config_file_provider_builder,\
    artifactory_common_details, artifactory_repository,\
    artifactory_deployment_patterns, artifactory_env_vars_patterns,\
    artifactory_optional_props
...
def artifactory_maven3_freestyle(parser, xml_parent, data):
    """ yaml: artifactory-maven3-freestyle
