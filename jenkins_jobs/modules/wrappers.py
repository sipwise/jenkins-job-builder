...
def config_file_provider(parser, xml_parent, data):
    ...
    :arg list files: List of managed config files each denoted by **file** each
      file can take three parameters:
        :Parameter: * **file-id**  The identifier for the managed config file
        :Parameter: * **target**  Optionally defines where the file should be created
        :Parameter: * **variable**  Optionally Defines an environment variable to be
