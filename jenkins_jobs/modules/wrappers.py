...
def release(parser, xml_parent, data):
    ...
    :arg list parameters: Release parameters (see the `Parameters` module)
    :arg list pre-build: Pre-build steps (see the `Builders` module)
    :arg list post-build: Post-build steps (see `Builders`)
    :arg list post-success: Post successful-build steps (see `Builders`)
    :arg list post-failed: Post failed-build steps (see `Builders`)
