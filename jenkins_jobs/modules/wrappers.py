...
def inject(parser, xml_parent, data):
    ...
    if 'properties-file-path' in data:
        XML.SubElement(info, 'propertiesFilePath').text = data[
            'properties-file-path']
    if 'properties-content' in data:
        XML.SubElement(info, 'propertiesContent').text = data[
            'properties-content']
    if 'script-file-path' in data:
        XML.SubElement(info, 'scriptFilePath').text = data[
            'script-file-path']
    if 'script-content' in data:
        XML.SubElement(info, 'scriptContent').text = data[
            'script-content']
