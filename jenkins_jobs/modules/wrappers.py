...
def github_pull_request(parser, xml_parent, data):
    ...
    .. literalinclude:: /../../tests/wrappers/fixtures/github-pull-request001.yaml
       :language: yaml
    .. literalinclude:: /../../tests/wrappers/fixtures/github-pull-request002.yaml
       :language: yaml
    ...
    if statuses:
        ...
        for status in statuses:
            ...
            result_tag = XML.SubElement(completed_tag,
                                        'org.jenkinsci.plugins.ghprb.extensions'
                                        '.comments.GhprbBuildResultMessage')
            convert_mapping_to_xml(result_tag, status, status_mapping,
                                   fail_required=True)
