...
def env_script(parser, xml_parent, data):
    ...
    :arg run-only-on-parent: Only applicable for Matrix Jobs. If true, run only
      on the matrix parent job
