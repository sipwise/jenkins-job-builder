...
def dynamic_choice_param(parser, xml_parent, data):
    ...
    :arg bool remote: the script will be executed on the slave where the build is started (default is false)
    :arg str classpath: class path for script (optional)
    :arg bool readonly: user can't modify parameter once populated (default is false)
...
def dynamic_choice_scriptler_param(parser, xml_parent, data):
    ...
    :arg str name: the name of the parameter
    :arg str description: a description of the parameter (optional)
    :arg str scriptid: Groovy expression which generates the potential choices.
    ...
    Example::
      ...
      parameters:
        - dynamic-choice-scriptler:
            ...
            readonly: False
    """
    dynamic_scriptler_param_common(parser, xml_parent, data, 'ScriptlerChoiceParameterDefinition')
    ...
    Example::
      ...
      parameters:
        - dynamic-string-scriptler:
            ...
            readonly: False
    """
    dynamic_scriptler_param_common(parser, xml_parent, data, 'ScriptlerStringParameterDefinition')
...
def dynamic_param_common(parser, xml_parent, data, ptype):
    ...
    XML.SubElement(default, 'remote').text = "/var/lib/jenkins/dynamic_parameter/classpath";  
    ...
    XML.SubElement(pdef, 'readonlyInputField').text = str(data.get('readonly', False)).lower()
...
def dynamic_scriptler_param_common(parser, xml_parent, data, ptype):
    ...
    XML.SubElement(pdef, '__remote').text = str(data.get('remote', False)).lower()
    XML.SubElement(pdef, '__scriptlerScriptId').text = data.get('scriptid', None)
    ...
    if parameters:
        for parameter in parameters:
            parameterXML = XML.SubElement(parametersXML,
                                   ...
                                   'ScriptlerParameterDefinition_-ScriptParameter')
