...
def credentials_param(registry, xml_parent, data):
    ...
    :arg bool required: whether this parameter is required (optional, default false)
    ...
    Example::
      ...
      parameters:
        - credentials:
            ...
            required: true
            description: "Credentials to use for API access"
    """
    cred_impl_types = { 'any': 'com.cloudbees.plugins.credentials.common.StandardCredentials',
        'usernamepassword': 'com.cloudbees.plugins.credentials.impl.UsernamePasswordCredentialsImpl',
        'sshkey': 'com.cloudbees.jenkins.plugins.sshcredentials.impl.BasicSSHUserPrivateKe',
        'secretfile': 'org.jenkinsci.plugins.plaincredentials.impl.FileCredentialsImpl',
        'secrettext': 'org.jenkinsci.plugins.plaincredentials.impl.StringCredentialsImpl',
