...
def dynamic_choice_param(parser, xml_parent, data):
    ...
    :arg str name: The name of the parameter.
    :arg str script: The script returning list of choices.
    :arg str description: A description of the parameter. (optional)
    ...
    XML.SubElement(pdef, 'readonlyInputField').text = str(data.get('read_only', False)).lower()
    XML.SubElement(pdef, '__localBaseDirectory').attrib['serialization'] = 'custom'


def dynamic_string_param(parser, xml_parent, data):
    """yaml: dynamic_string_param
    ...
    :arg str name: The name of the parameter.
    :arg str script: The script returning the parameter default.
    :arg str description: A description of the parameter. (optional)
    :arg bool read_only: Whether the field should be read only. (optional)
    :arg str class_paths: class paths (optional)
    ...
    Example::
        - dynamic_string:
            ...
            script: |
                return "Hello world"
            description: |
                This is a description of the bar param.
            read_only: False
    """
    pdef = base_param(parser, xml_parent, data, False,
