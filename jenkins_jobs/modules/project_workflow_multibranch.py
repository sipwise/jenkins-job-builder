...
.. literalinclude::
   /../../tests/modules/fixtures/project_pipeline_multibranch_template002.yaml
...
class WorkflowMultiBranch(jenkins_jobs.modules.base.Base):
    sequence = 0
    jenkins_class = 'org.jenkinsci.plugins.workflow.multibranch.WorkflowMultiBranchProject'  # noqa
    module_blacklist = ['jenkins_jobs.modules.scm.SCM',
                        'jenkins_jobs.modules.scm.PipelineSCM']

    def root_xml(self, data):

        project_def = data

        xml_parent = XML.Element(self.__class__.jenkins_class)
        ...
        owner.attrib['class'] = (self.__class__.jenkins_class)
        ...
        XML.SubElement(allView, 'properties',
        ...
        XML.SubElement(
            folderViews, 'owner',
            {'class': 'org.jenkinsci.plugins.workflow.multibranch.WorkflowMultiBranchProject',  # noqa
            'reference': '../..'})
...
class WorkflowMultiBranchDefaults(WorkflowMultiBranch):
        jenkins_class = 'org.jenkinsci.plugins.pipeline.multibranch.defaults.PipelineMultiBranchDefaultsProject'  # noqa
