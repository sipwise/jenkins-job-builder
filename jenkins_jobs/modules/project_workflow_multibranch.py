...
:Job Parameters:
    ...
    * **multibranch** (`dict`):
        ...
        * **periodic-folder-spec** (`str`): The timer spec for when the
          repository should be checked for branches. (optional)
    ...
    * **scm** (`list`): The SCM definition.
        ...
        * **github** (`str`): Use this as sub-structure of scm when using
          github.
