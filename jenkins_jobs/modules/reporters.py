...
def findbugs(parser, xml_parent, data):
    ...
    :arg dict thresholds:
        :thresholds:
            * **unstable-all** (`int`) - Unstable all threshold.
            * **unstable-high** (`int`) - Unstable high threshold.
            * **unstable-normal** (`int`) - Unstable normal threshold.
            * **unstable-low** (`int`) - Unstable low threshold.
            * **failed-all** (`int`) - Failed all threshold.
            * **failed-high** (`int`) - Failed high threshold.
            * **failed-normal** (`int`) - Failed normal threshold.
            * **failed-low** (`int`) - Failed low threshold.
