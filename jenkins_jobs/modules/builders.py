...
def copyartifact(parser, xml_parent, data):
    ...
    :arg str which-build: (optional, default: last-successful)

      :which-build values:
        * **last-successful**
        * **specific-build**

          * **build-number** (`str`) -- Build number to retrieve

        * **last-saved**
        * **upstream-build**

          * **fallback-to-last-successful** (`bool`) --Fallback to last
            successful

        * **permalink** (`str`) -- Relative link
          ...
          :permalink values:
            ...
            * **last-successful**
              ...
              * **stable** (`bool`) -- Only last stable build
            ...
            * **build-param**
              ...
              * **param** (`string`) -- Use a build parameter to get the build
