...
def trigger_builds(parser, xml_parent, data):
    ...
    :arg (bool or obj) git-revision: Whether to pass the git revision
      to the triggered job.
        :arg bool combine-queued-commits: Whether to combine
    ...
    for project_def in data:
        ...
        if(project_def.get('git-revision')):
            ...
            try:
              # If git-revision is a boolean, the get() will throw an AttributeError
              if project_def['git-revision'].get('combine-queued-commits'):
