...
def copyartifact(parser, xml_parent, data):
    ...
    :arg string filter-parameters: Filter matching jobs based on these parameters.
    :which-build values:
      * **last-successful**
      * **specific-build**
      * **last-saved**
    ...
    Example::
      ...
      builders:
        - copyartifact:
            ...
            build-number: 123
            flatten: true
            filter-parameters: PUBLISH=true
    """
    ...
    XML.SubElement(t, 'parameters').text = data.get("filter-parameters", "")
