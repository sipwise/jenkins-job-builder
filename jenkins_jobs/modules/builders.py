...
def nexus_artifact_uploader(registry, xml_parent, data):
    ...
    :arg str protocol: Protocol to use to connect to Nexus (default to https)
    :arg str nexus_url: Nexus url (without protocole)
    :arg str nexus_user: Username to upload artifact to Nexus
    ...
    :arg str type: Type to set for the artifact to upload
    ...
    :arg str file: File which will be the uploaded artifact
