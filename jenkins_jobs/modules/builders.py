...
def python_virtualenv(parser, xml_parent, data):
    ...
    *  **python**
    ...
    naturedict = {'shell': 'shell',
                  'xshell': 'xshell',
                  'python': 'python'}
    if nature not in naturedict:
        raise JenkinsJobsException("nature entered is not valid must be "
                                   "one of shell, xshell or python")
    XML.SubElement(t, 'nature').text = naturedict[nature]
