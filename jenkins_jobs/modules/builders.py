...
def http_request(parser, xml_parent, data):
    ...
    if 'mode' in data and data.get('mode') not in valid_modes:
        raise InvalidAttributeError('mode', data.get('mode'), valid_modes)
    if 'content-type' in data and data.get('content-type') not in valid_types:
        raise InvalidAttributeError('content-type',
                                    data.get('content-type'),
                                    valid_modes)
    if 'accept-type' in data and data.get('accept-type') not in valid_types:
