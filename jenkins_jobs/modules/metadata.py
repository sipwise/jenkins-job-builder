...
def base_metadata(parser, xml_parent, data, do_default, mtype):
    ...
    exposed = data.get('expose-to-env', False)
    if exposed:
...
def string_metadata(parser, xml_parent, data):
    ...
    :arg bool expose-to-env: exposure of the metadata  to environment (optional)
...
def date_metadata(parser, xml_parent, data):
    ...
    :arg str name: the name of the metadata
    :arg str time: time value of the metadata, in milliseconds since 1970-01-01 00:00:00 UTC
