...
class WorkflowMultiBranch(jenkins_jobs.modules.base.Base):
    sequence = 0
    jenkins_class = ('org.jenkinsci.plugins.workflow.multibranch'
                     '.WorkflowMultiBranchProject')

    jenkins_factory_class = ('org.jenkinsci.plugins.workflow.multibranch'
    ...
    def root_xml(self, data):
        ...
        owner.attrib['class'] = (self.jenkins_class)
        ...
        for scm in project_def['scm']:
            ...
            if 'github' in scm:
                ...
                # implicitly added on GUI, no branches discovered without it
        ...
        factory.attrib['class'] = self.jenkins_factory_class
        factory_owner = XML.SubElement(factory, 'owner')
        factory_owner.attrib['class'] = self.jenkins_class
...
class WorkflowMultiBranchDefaults(WorkflowMultiBranch):
        ...
        jenkins_factory_class = 'org.jenkinsci.plugins.pipeline.multibranch' \
