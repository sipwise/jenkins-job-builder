...
def gerrit_scm(xml_parent, data):
    ...
    source = XML.SubElement(
        xml_parent,
        "source",
        {"class": "jenkins.plugins.gerrit.GerritSCMSource", "plugin": "gerrit-code-review"},
    )
    source_mapping = [
    ...
    if checks:
        checks_trait = XML.SubElement(traits, 'jenkins.plugins.gerrit.traits.FilterChecksTrait')
