...
def bitbucket_scm(xml_parent, data):
    ...
    :arg str repo: The repo.
    :arg str repo-owner: Bitbucket project/repo owner.
    :arg str scan-credentials-id: The credentialsId to use to scan github.
        (default 'SAME')
    :arg str checkout-credentials-id: The credential to use to checkout from
        bitbucket. (default none)
    :arg str bitbucket-server-url: Bitbucket server URL, to be set when used
        with Bitbucket Server. (default none)
    :arg bool auto-register-webhook: Register webhook in Bitbucket.
        (default false)
    :arg int ssh-port: Bitbucket ssh port. (default none)
    :arg str repository-type: BitBucket repo type. (default 'GIT')
...
def github_scm(xml_parent, data):
    ...
    :arg str repo-owner: The GitHub repo owner.
    :arg str scan-credentials-id: The credential to use to scan GitHub.
    :arg str checkout-credentials-id: The credential to use to checkout from
        github. (default scan-credentials-id)
    :arg str api-uri: The GitHub API uri for hosted/on-site GitHub.
    :arg bool build-origin-branch: Build origin branches. (default true)
    :arg bool build-origin-branch-with-pr: Build origin branches also filed as
        PRs. (default true)
    :arg bool build-origin-pr-merge: Build origin PRs (merged with base
        branch). (default false)
    :arg bool build-origin-pr-head: Build origin PRs (unmerged head).
        (default false)
    :arg bool build-fork-pr-merge: Build fork PRs (merged with base branch).
        (default true)
    :arg bool build-fork-pr-head: Build fork PRs (unmerged head).
        (default false)
    :arg str branch-discovery: How to discover branches. Valid options:
        no-pr, only-pr, all. (default undefined)
    :arg str discover-pr-forks-strategy: Fork strategy. Valid options:
        merge-current, current, both. (default undefined)
    :arg str discover-pr-forks-trust: Fork trust. Valid options:
        contributors, everyone, permission or nobody.  (default 'contributors')
    :arg str discover-pr-origin: Discover origin. Valid options:
        merge-current, current, both.  (default undefined)
    :arg str includes: Comma-separated list of branches to be included.
        (default '\*, all')
    :arg str excludes: Comma-separated list of branches to be excluded.
