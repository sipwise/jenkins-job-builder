...
.. literalinclude::
   /../../tests/multibranch/fixtures/project_multibranch_defaults.yaml

.. literalinclude::
   /../../tests/multibranch/fixtures/project_multibranch_multi_scm_full.yaml
...
def bitbucket_scm(xml_parent, data):
    ...
    .. literalinclude::
       /../../tests/multibranch/fixtures/project_multibranch_bitbucket_min.yaml
    """
...
def gerrit_scm(xml_parent, data):
    ...
    .. literalinclude::
       /../../tests/multibranch/fixtures/project_multibranch_gerrit_min.yaml
...
def git_scm(xml_parent, data):
    ...
    .. literalinclude::
       /../../tests/multibranch/fixtures/project_multibranch_git_min.yaml
    """
    source = XML.SubElement(xml_parent, 'source', {
...
def github_scm(xml_parent, data):
    ...
    :arg str scan-credentials-id: Credentials used to scan branches and pull
        requests, check out sources and mark commit statuses. (required)
    ...
    :arg str branch-discovery: Discovers branches on the repository.
        Valid options: no-pr, only-pr, all. (default 'no-pr')
    ...
    if data.get('discover-pr-origin', 'merge-current'):
