...
"""
The Matrix Project module handles creating Matrix Jenkins
projects. To crate a Martrix Project specify ``matrix`` in the
    ...
    def root_xml(self, data):
        ...
        if 'touchstone' in ex_d:
            ...
            if n not in ('STABLE', 'UNSTABLE'):
                raise ValueError('Required result must be stable or ' \
                                 'unstable')
