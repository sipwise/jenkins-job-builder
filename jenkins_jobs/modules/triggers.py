...
def monitor_folders(parser, xml_parent, data):
    ...
    :arg str excludes: The 'excludes' pattern. A file that matches this mask
      ...
      section. (default: '')
    :arg bool exclude-check-date: Check last modification date.
      (default: False)
    :arg bool exclude-check-content: Exclude check content. (default: False)
    :arg bool exclude-check-fewer: Exclude check fewer files (default: False)
    ...
    mappings = [
        ...
        ('excludes', 'excludes', ''),
        ('cron', 'spec', ''),
        ('exclude-check-date', 'excludeCheckLastModificationDate', False),
        ('exclude-check-content', 'excludeCheckContent', False),
        ('exclude-check-fewer', 'excludeCheckFewerOrMoreFiles', False),
    ]
