...
def gerrit(parser, xml_parent, data):
    ...
    :arg str server-name: Name of the server to trigger on. Use ''__ANY__''
        to trigger on any configured Gerrit server.  Requires Gerrit Trigger
