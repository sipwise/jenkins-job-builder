...
def jira_changelog_trigger(registry, xml_parent, data):
    """yaml: jira-changelog-trigger
    ...
    :arg list changelog-matchers:
        ...
        :Custom Field Matcher: 
            * **custom-field-name** (`str`) -- The custom field name that has been changed
                during the issue update. (default '')
            * **compare-new-value** (`bool`) -- Compare the new value of the updated field.
            * **new-value** (`str`) -- The new value of the updated field.
            * **compare-old-value** (`bool`) -- Compare the old value of the updated field.
            * **compare-old-value** (`str`) -- The value before the field is updated.

        :JIRA Field Matcher:
            * **jira-field-ID** (`str`) -- The JIRA Field ID that has been changed
                during the issue update. (default '')
            * **compare-new-value** (`bool`) -- Compare the new value of the updated field.
            * **new-value** (`str`) -- The new value of the updated field.
            * **compare-old-value** (`bool`) -- Compare the old value of the updated field.
    ...
    .. literalinclude::
        /../../tests/triggers/fixtures/jira-changelog-trigger-minimal.yaml
       :language: yaml

    Full Example:

    .. literalinclude::
        /../../tests/triggers/fixtures/jira-changelog-trigger-full.yaml
       :language: yaml
    """
