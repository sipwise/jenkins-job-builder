...
def gitlab_merge_request(registry, xml_parent, data):
    ...
    :arg string use-http-url: use the HTTP(S) URL to fetch/clone repository (default False)
    ...
    :arg string auto-close-failed: on failure, auto close the request (default False)
    :arg string auto-merge-passed: on success, auto merge the request (default False)
