...
def pollscm(parser, xml_parent, data):
    ...
    :arg string cron: the polling interval (cron syntax)
    ...
    if type(data) == type(str()):
        ...
        logger.error("Empty pollscm trigger doesn't make sense")
        cron = ''
        ipch = False
    else:
        ...
        if cron == '':
            logger.error("No cron expression defined in pollscm")
