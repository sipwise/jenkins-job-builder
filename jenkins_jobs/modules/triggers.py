...
def gitlab(parser, xml_parent, data):
    ...
    :arg bool trigger-merge-request: Build on Merge Request Events (default
        True)
    :arg bool/str trigger-open-merge-request-push: Rebuild open Merge Requests
        on Push Events (< 1.1.26) (default true) / (>= 1.1.26) (default never)
    ...
    .. literalinclude::
        /../../tests/publishers/fixtures/gitlab004.yaml
        :language: yaml

    Minimal example (version >= 1.1.26):

    .. literalinclude::
        /../../tests/publishers/fixtures/gitlab005.yaml
        :language: yaml
    """
