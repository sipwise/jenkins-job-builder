...
def ivy(parser, xml_parent, data):
    ...
    :arg str properties-file: One or more properties file path. Separate file
      paths with a semi-colon. Properties will be injected as variables in the
      ivy settings file. (optional)
