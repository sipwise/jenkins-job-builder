...
**update**
  (Optional) If set to one of the values "jobs" or "views" or "all", will allow
  ...
  updates both jobs and views. Note, when the CLI options overrides config file
  options. 'all' by default.
