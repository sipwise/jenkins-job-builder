...
create a view, you must define a view in a YAML file and have a variable called
view-type with a valid value. It looks like this::
...
Views are processed differently than Jobs and therefore will not work within a
`Project`_ or a `Job Template`_.
