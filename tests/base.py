...
class BaseTestCase(object):
    ...
    def test_yaml_snippet(self):
        ...
        if (yaml_content.has_key('project-type')):
            ...
            if (yaml_content['project-type'] == "flow"):
              root_element = XML.Element('com.cloudbees.plugins.flow.BuildFlow')
            if (yaml_content['project-type'] == "multijob"):
              root_element = XML.Element('com.tikal.jenkins.plugins.multijob.MultiJobProject')
