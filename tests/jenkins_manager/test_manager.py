...
class TestCaseTestJenkinsManager(base.BaseTestCase):
    ...
    def test_admin_user_defaulting(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args_list[0][0][1:3], ('myuser', 'mypassword'))
        self.assertEqual(self.builder.admin_jenkins, 1) # second call
        self.assertEqual(jenkins_mock.call_args_list[1][0][1:3], ('myuser', 'mypassword'))
    ...
    def test_admin_user_specified(self, jenkins_mock):
        ...
        self.assertEqual(jenkins_mock.call_args_list[0][0][1:3], ('myuser', 'mypassword'))
        self.assertEqual(self.builder.admin_jenkins, 1) # second call
        self.assertEqual(jenkins_mock.call_args_list[1][0][1:3], ('myadminuser', 'myadminpassword'))
