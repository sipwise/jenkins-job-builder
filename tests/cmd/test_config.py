...
class TestConfigs(CmdTestsBase):
    ...
    @unittest.skipUnless(os.path.isfile(global_conf), "Skipping when global config missing.")
    ...
    @unittest.skipUnless(os.path.isfile(user_conf), "Skipping when user_conf missing.")
