...
class UpdateTests(CmdTestsBase):
    ...
    def test_update_jobs_and_delete_old(self, builder_mock, delete_job_mock,
        ...
        # get the instance and redirect some of the method mocks to call
        # real methods on a the above test object.
        instance = builder_mock.return_value
        instance.plugins_list = builder_obj.plugins_list
        instance.update_job.side_effect = builder_obj.update_job
        instance.delete_old_managed.side_effect = builder_obj.delete_old_managed
        ...
        # of times
        self.cache_mock.return_value.has_changed.side_effect = ([True] * 2 + [False] * 2)
