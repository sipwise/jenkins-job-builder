...
class UpdateTests(CmdTestsBase):
    ...
    def test_update_jobs_and_delete_old(self, builder_mock, delete_job_mock,
        ...
        Test update of jobs with the --delete-old option is enabled, where
        only some jobs are changed to limit the number of times update_job
        is called, and have the get_jobs() method return additional jobs to
        test that delete_job is called only for the extra jobs.
        """
